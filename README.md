                ...
                if ([...pinInputs].every(input => input.value.length === 1)) {
                    ...
                    surprise.innerHTML = `
                        <div class="message">
                            ...
                            คืนนี้ขอให้มึงนอนหลับอย่างสงบ ไม่มีอะไรในหัวให้ต้องคิดมาก ไม่ต้องกังวลกับสิ่งที่ยังไม่เกิดขึ้น หรือเสียดายกับสิ่งที่ผ่านไปแล้ว ขอให้หัวใจมึงรู้สึกโล่ง สบายใจ เหมือนได้วางทุกอย่างลงชั่วคราว แค่หายใจลึกๆ แล้วปล่อยให้ความสงบค่อยๆ ซึมเข้าสู่ใจของมึงทีละนิด 🍃<br><br>
                            ...
                            ขอให้คืนนี้มึงฝันดีที่สุดเท่าที่เคยฝันมา ฝันเห็นแต่สิ่งที่ทำให้มึงตื่นขึ้นมายิ้มได้ 😊 ขอให้มึงตื่นขึ้นมาในวันใหม่ด้วยความรู้สึกสดชื่น พร้อมเจอเรื่องดีๆ อีกมากมายที่กำลังรอมึงอยู่<br><br>
                            <span class="highlight">รักมึงเสมอ ไม่ว่าจะวันนี้หรือวันไหน ❤️🎂🎉</span>
                        </div>
                    `;
                }
            });
